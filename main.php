...
<?php } ?>
  ...
  <div class="w3-display-container w3-container">
    <img src="images/back.jpg" alt="Jeans" style="width:100%">
    <div class="w3-display-topleft w3-text-white" style="padding:24px 48px">
      <h1 class="w3-jumbo w3-hide-small">New arrivals</h1>
      <h1 class="w3-hide-large w3-hide-medium">New arrivals</h1>
      <h1 class="w3-hide-small">COLLECTION 2018</h1>
      <p><a href="#headphones" class="w3-button w3-black w3-padding-large w3-large">SHOP NOW</a></p>
    </div>
  </div>
  <div class="w3-container w3-text-grey" id="headphones">
    <?php
 ...
 <div class="w3-display-container">
        <img src="images/phonecase/<?php echo $row["image"] ?>" style="width:100%">
 <span class="w3-tag w3-display-topleft">New</span>
<div class="w3-display-middle w3-display-hover">
<button class="w3-button w3-black"><?php echo "<a href='details/details.php?id={$row['id']}'>"?>Buy now </a><i class="fa fa-shopping-cart"></i></button>
</div>
        </div>

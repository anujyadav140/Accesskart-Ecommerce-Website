...
<?php } ?>
  ...
  $res = mysqli_query($link,"select * from product_datacable where id = '$ID'");
  $row = mysqli_fetch_array($res);
?>
<form method="post" action="../add_to_cart.php?action=add$id=<?php echo $row['id'];?>" id="forms">
<img src="../images/datacable/<?php echo $row["image"] ?>" class="img">
...
if (isset($_GET['id'])) {
  ...
  $row = mysqli_fetch_array($res);
?>
<h1 style="position: relative;left: 8px;">Write Your Review </h1><hr>
<div class="container">

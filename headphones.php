...
<?php } ?>
  ...
  <div class="w3-container w3-text-grey">
    <?php
    $res = mysqli_query($link,"SELECT * FROM product_headphone");
    $count = 0;
 ...
 <div class="w3-display-container">
        <img src="images/headphone/<?php echo $row["image"] ?>" style="width:100%">
 <span class="w3-tag w3-display-topleft">New</span>
<div class="w3-display-middle w3-display-hover">
<button class="w3-button w3-black"><?php echo "<a href='details/details2.php?id={$row['id']}'>"?>Buy now </a><i class="fa fa-shopping-cart"></i></button>
</div>
        </div>
